...
By default, the [puppet-nfs](https://github.com/ULHPC/puppet-nfs) repository is bound to the [ulhpc-puppet-nfs](http://ulhpc-puppet-nfs.rtfd.org) project on Read the Docs (to avoid confusion with other nfs projects). 
